return {
	...
	s({ trig = ";T", snippetType = "autosnippet", desc = "Tau", wordTrig = false }, { t("\\Tau") }),
	...
	s({ trig = ";W", snippetType = "autosnippet", desc = "Omega", wordTrig = false }, { t("\\Omega") }),
	s({ trig = ";.", snippetType = "autosnippet", desc = "dot", wordTrig = false }, { t("\\cdot") }),
	s({ trig = "\\n", snippetType = "autosnippet", desc = "nabla", wordTrig = false }, { t("\\nabla") }),
	s({ trig = "\\b", snippetType = "autosnippet", desc = "bar", wordTrig = false }, { t("\\mathbf{"), i(1), t("}") }),
	s({ trig = ";;", snippetType = "autosnippet", desc = "inline math", wordTrig = false }, { t("$"), i(1), t("$") }),
	s(
		{ trig = "$$", snippetType = "autosnippet", desc = "block math", wordTrig = false },
		fmta(
			[[
    $$
    <>
	...
	s(
		{ trig = "\\l(", snippetType = "autosnippet", desc = "left(", wordTrig = false },
		{ t("\\left("), i(1), t("\\right)") }
	),
	s(
		{ trig = "//", snippetType = "autosnippet", desc = "fraction", wordTrig = false },
		fmta(
			[[
    \frac{<>}{<>}<>
    ]],
